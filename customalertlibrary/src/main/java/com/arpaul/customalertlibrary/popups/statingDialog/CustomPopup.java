...
public class CustomPopup {
    ...
    private CustomPopupType DIALOG_TYPE;
...
//            pwindo.setAnimationStyle(R.style.AnimationSlideVertical);
            ...
            if(hashTypeface.containsKey(CustomPopupTypeFace.DIALOG_BODY)){
                tvContentBody.setTypeface(hashTypeface.get(CustomPopupTypeFace.DIALOG_BODY).tfFont,
            ...
            if(hashTextColor.containsKey(CustomPopupTypeFace.DIALOG_BODY)){
                tvContentBody.setTextColor(hashTextColor.get(CustomPopupTypeFace.DIALOG_BODY));
            }
