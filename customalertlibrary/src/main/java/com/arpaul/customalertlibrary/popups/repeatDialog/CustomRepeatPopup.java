package com.arpaul.customalertlibrary.popups.repeatDialog;
 ...
 */
public class CustomRepeatPopup {
    ...
    private PopupRepeatListener listener;
    ...
    public CustomRepeatPopup(@NonNull Context context, @NonNull PopupRepeatListener listener, @NonNull String messageTitle,
...
//            pwindo.setAnimationStyle(R.style.AnimationSlideVertical);
            ...
            if(hashTypeface.containsKey(CustomPopupTypeFace.DIALOG_WEEK)){
                tvSunday.setTypeface(hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).tfFont,
                        hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).style);

                tvMonday.setTypeface(hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).tfFont,
                        hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).style);

                tvTuesday.setTypeface(hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).tfFont,
                        hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).style);

                tvWednesday.setTypeface(hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).tfFont,
                        hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).style);

                tvThursday.setTypeface(hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).tfFont,
                        hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).style);

                tvFriday.setTypeface(hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).tfFont,
                        hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).style);

                tvSaturday.setTypeface(hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).tfFont,
                        hashTypeface.get(CustomPopupTypeFace.DIALOG_WEEK).style);
            }
            ...
            if(hashTextColor.containsKey(CustomPopupTypeFace.DIALOG_WEEK)){
                tvSunday.setTextColor(hashTextColor.get(CustomPopupTypeFace.DIALOG_WEEK));
                tvMonday.setTextColor(hashTextColor.get(CustomPopupTypeFace.DIALOG_WEEK));
                tvTuesday.setTextColor(hashTextColor.get(CustomPopupTypeFace.DIALOG_WEEK));
                tvWednesday.setTextColor(hashTextColor.get(CustomPopupTypeFace.DIALOG_WEEK));
                tvThursday.setTextColor(hashTextColor.get(CustomPopupTypeFace.DIALOG_WEEK));
                tvFriday.setTextColor(hashTextColor.get(CustomPopupTypeFace.DIALOG_WEEK));
                tvSaturday.setTextColor(hashTextColor.get(CustomPopupTypeFace.DIALOG_WEEK));
            }
